CREATE DATABASE  IF NOT EXISTS `guyra` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `guyra`;
-- MySQL dump 10.13  Distrib 8.0.36, for Win64 (x86_64)
--
-- Host: localhost    Database: guyra
-- ------------------------------------------------------
...
CREATE TABLE `compras` (
  ...
  CONSTRAINT `fk_tipo` FOREIGN KEY (`tipo`) REFERENCES `ingressos` (`tipo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-05-27 15:01:02
